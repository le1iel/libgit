...
bool
Reference::isBranch () const noexcept
{
...
bool
Reference::isNote () const noexcept
{
...
bool
Reference::isTag () const noexcept
{
...
bool
Reference::isRemote () const noexcept
{
...
std::string
Reference::shorthand () const noexcept
{
    std::string out{};
...
std::optional<git_error>
Reference::resolve () noexcept
{
    git_reference *ref = nullptr;
